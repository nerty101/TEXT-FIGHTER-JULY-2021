...
if (magchn > 2)
{
printf("     You assembled a Magic Bonus Chain total of %d!\n", magchn);
}
...
if (bonchn > 2)
{
printf("     You have collected a Bonus Chain total of %d!\n", bonchn);
}
...
if (((cpusp > 1) && (ctr < 6) && (new6 > 0)) || ((bonchn > 2) && (ctr < 6) && (new6 > 0)) || ((magchn > 2) && (ctr < 6) && (new6 > 0)))
printf("\n");
if (new6 > 0)
