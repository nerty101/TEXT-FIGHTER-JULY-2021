...
int emgspcom5 = 0, emagsup5 = 0, mspatt5 = 0, enspcomb6 = 0, bonrec = 0, magrec = 0, bonrec2 = 0, magrec2 = 0, spmag3 = 0, fghton = 0, fghton2 = 0, new9 = 0, wnct8 = 0, cpuwn8 = 0, magsp4 = 0, f2 = 0;
...
if ((cpusp < 2) && (ctr < 6) && (new6 > 0) && (bonchn > 2) && (magchn < 3))
printf("\n");
if ((cpusp < 2) && (ctr < 6) && (new6 < 1) && (bonchn > 2) && (magchn > 2))
printf("\n");
if (magchn > 2)
printf("     You had a Magic Bonus Chain of %d!\n", magchn);
if ((cpusp < 2) && (ctr < 6) && (new6 > 0) && (bonchn < 3) && (magchn > 2))
printf("\n");
if ((cpusp > 1) && (ctr < 6) && (new6 > 0) && (bonchn < 3) && (magchn < 3))
printf("\n");
if ((cpusp < 2) && (ctr < 6) && (new6 > 0) && (bonchn > 2) && (magchn > 2))
printf("\n");
if ((cpusp > 1) && (ctr > 5) && (new6 > 0) && (bonchn < 3) && (magchn < 3))
printf("\n");
if ((cpusp < 2) && (ctr > 5) && (new6 > 0) && (bonchn > 2) && (magchn > 2))
printf("\n");
if (new6 > 0)
